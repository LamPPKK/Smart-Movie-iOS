...
- Đánh dấu đã xem cho season/episode; hiển thị tiến độ series, tập kế tiếp và nút tiếp tục từ Library/Detail. **Episode progress đã có trên cả ba client:** Apple SwiftData, Android Room v4 và KMP KeyValueStore đều hỗ trợ toggle từng tập/cả mùa, tiến độ mùa, offline persistence, canonical `series:season:episode` và bản địa hóa. Tiến độ toàn series, tập kế tiếp và Continue vẫn đang chờ.
